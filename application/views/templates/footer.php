                ...
                <div class="col-sm-5">
                    <div class="subscribe">
                        <form id="subscribeForm" class="subscribe-form">
                            <input type="submit" class="submit" value="Email: info@qualitybuilder.in">
                            <input class="call-chimp" value="Call us: 0483 277 1931">
                        </form>
                    </div>
                </div>
            </div> 
                ...
                <div class="row"> 
                    <div class="col-md-3">  
                        <div class="widget widget_text widget_info">
                            ...
                            <div class="textwidget">                                
                                <p>
                                    We provide a professional service for diverse clientele across a broad spectrum of business in both the public and private sectors. 
                                </p>
                    ...
                    <div class="col-md-3">  
                        <div id="nav_menu-2" class="widget widget_nav_menu">
                            <h2 class="widget-title">First Touch</h2>
                            <div class="menu-footer-container">
                                <ul id="menu-footer" class="menu">
                                    <li class="menu-item"><a href="home#mission">Our Vision & Mission</a></li>
                                    <li class="menu-item"><a href="home#latest">Our Latest Projects</a></li>
                                    <li class="menu-item"><a href="home#quote">Get You Free Quote Now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div><!-- /.col-md-3 -->
                    ...
                    <div class="col-md-3">  
                        <div id="nav_menu-2" class="widget widget_nav_menu">
                            <h2 class="widget-title">Quik Links</h2>
                            <div class="menu-footer-container">
                                <ul id="menu-footer" class="menu">
                                    <li class="menu-item"><a href="moments">About Us</a></li>
                    ...
                    <div class="col-md-3">  
                        <div class="widget widget_text widget_info">
                            ...
                            <div class="textwidget">                                
                                <p>
                                    Quality Builders, 12/688, Metro Building <br />
                                    Oppo. GHSS School, Aravankara<br />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright text-center"> 
                        <p>© Copyright <a href="#">Psybo Technologies</a> 2017. All Rights Reserved.
                        </p>
                    </div>                   
                </div><!-- /.col-md-6 -->              
            </div><!-- /.row -->
    ...
    <script type="text/javascript" src="<?php echo base_url();?>javascript/jquery.fitvids.js"></script>
